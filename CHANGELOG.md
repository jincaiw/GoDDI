...
- Build and run the production container in CI; smoke test both Linux architectures on their native runners and smoke test the release binary before publishing it.
