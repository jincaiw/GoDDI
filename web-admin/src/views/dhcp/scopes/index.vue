...
const columns = [
  ...
  { title: () => t('common.actions'), key: 'actions', width: 160, render: (row: DHCPScope) => h(NSpace, null, {
    default: () => [
      h(NButton, { size: 'small', text: true, disabled: !perm.canWrite('dhcp'), onClick: () => { editingScope.value = row; Object.assign(formData, row); showModal.value = true } }, { default: () => t('common.edit') }),
