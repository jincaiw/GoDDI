...
import { listUsers, createUser, updateUser, deleteUser, assignUserRoles, type User, type CreateUserRequest } from '@/service/api/goddi/user'
...
async function handleAssignRoles() {
  if (!perm.canWrite('user') || !perm.canRead('role')) return
  try {
