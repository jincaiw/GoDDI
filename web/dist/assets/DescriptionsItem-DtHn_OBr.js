import{E as e,g as t,k as n}from"./vue.runtime.esm-bundler-B46jYzg4.js";import{Br as r,Fn as i,Gr as a,Hr as o,Kn as s,Pn as c,Rr as l,Tr as u,Ur as d,Vr as f,Wr as p,gn as m,mr as h,zr as g}from"./router-JyNjPC5e.js";import{u as _}from"./DataTable-rAw_PzXD.js";import{d as v}from"./index--t-ybY1L.js";function y(e,t=`default`,n=[]){let{children:r}=e;if(typeof r==`object`&&r&&!Array.isArray(r)){let e=r[t];if(typeof e==`function`)return e()}return n}var b=l([g(`descriptions`,{fontSize:`var(--n-font-size)`},[g(`descriptions-separator`,`
