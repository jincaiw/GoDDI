<<<<<<<< HEAD:web/dist/assets/Switch-DxAcw-Ui.js
import{O as e,j as t,mt as n,ut as r,v as i}from"./echarts-eUEtiXc8.js";import{B as a,E as o,H as s,L as c,O as l,P as u,S as d}from"./auth-BqKin8Qo.js";import{O as f,j as p}from"./vue-core-CcEAoDdX.js";import{B as m,G as h,J as g,K as _,N as v,P as y,X as b,Y as x,Z as S,i as C,t as w}from"./light-BKCENzy2.js";import{c as T}from"./_plugin-vue_export-helper-CteSXPyx.js";import{i as E}from"./index-BFRegr9_.js";function D(e){let{primaryColor:t,opacityDisabled:n,borderRadius:r,textColor3:i}=e;return Object.assign(Object.assign({},E),{iconColor:i,textColor:`white`,loadingColor:t,opacityDisabled:n,railColor:`rgba(0, 0, 0, .14)`,railColorActive:t,buttonBoxShadow:`0 1px 4px 0 rgba(0, 0, 0, 0.3), inset 0 0 1px 0 rgba(0, 0, 0, 0.05)`,buttonColor:`#FFF`,railBorderRadiusSmall:r,railBorderRadiusMedium:r,railBorderRadiusLarge:r,buttonBorderRadiusSmall:r,buttonBorderRadiusMedium:r,buttonBorderRadiusLarge:r,boxShadowFocus:`0 0 0 2px ${m(t,{alpha:.2})}`})}var O={name:`Switch`,common:w,self:D},k=_(`switch`,`
========
import{E as e,ct as t,ft as n,g as r,k as i}from"./echarts-Cw2yHLaZ.js";import{B as a,E as o,H as s,L as c,O as l,P as u,S as d}from"./auth-RfiMf961.js";import{O as f,j as p}from"./vue-core-BDTvi3xZ.js";import{B as m,G as h,J as g,K as _,N as v,P as y,X as b,Y as x,Z as S,i as C,t as w}from"./light-BluJl8SD.js";import{s as T}from"./get-BLwATRqs.js";import{i as E}from"./index-CRgX9Dvo.js";function D(e){let{primaryColor:t,opacityDisabled:n,borderRadius:r,textColor3:i}=e;return Object.assign(Object.assign({},E),{iconColor:i,textColor:`white`,loadingColor:t,opacityDisabled:n,railColor:`rgba(0, 0, 0, .14)`,railColorActive:t,buttonBoxShadow:`0 1px 4px 0 rgba(0, 0, 0, 0.3), inset 0 0 1px 0 rgba(0, 0, 0, 0.05)`,buttonColor:`#FFF`,railBorderRadiusSmall:r,railBorderRadiusMedium:r,railBorderRadiusLarge:r,buttonBorderRadiusSmall:r,buttonBorderRadiusMedium:r,buttonBorderRadiusLarge:r,boxShadowFocus:`0 0 0 2px ${m(t,{alpha:.2})}`})}var O={name:`Switch`,common:w,self:D},k=_(`switch`,`
>>>>>>>> e53a2cc (feat: redesign console UI (dark+light design system) and add session management):web/dist/assets/Switch-hIX5t2y-.js
 height: var(--n-height);
...
========
 `)])]),A=Object.assign(Object.assign({},C.props),{size:String,value:{type:[String,Number,Boolean],default:void 0},loading:Boolean,defaultValue:{type:[String,Number,Boolean],default:!1},disabled:{type:Boolean,default:void 0},round:{type:Boolean,default:!0},"onUpdate:value":[Function,Array],onUpdateValue:[Function,Array],checkedValue:{type:[String,Number,Boolean],default:!0},uncheckedValue:{type:[String,Number,Boolean],default:!1},railStyle:Function,rubberBand:{type:Boolean,default:!0},spinProps:Object,onChange:[Function,Array]}),j,M=e({name:`Switch`,props:A,slots:Object,setup(e){j===void 0&&(j=typeof CSS<`u`?CSS.supports===void 0?!1:CSS.supports(`width`,`max(1px)`):!0);let{mergedClsPrefixRef:i,inlineThemeDisabled:a,mergedComponentPropsRef:o}=y(e),c=C(`Switch`,`-switch`,k,O,e,i),l=u(e,{mergedSize(t){return e.size===void 0?t?t.mergedSize.value:o?.value?.Switch?.size||`medium`:e.size}}),{mergedSizeRef:d,mergedDisabledRef:m}=l,h=t(e.defaultValue),g=T(n(e,`value`),h),_=r(()=>g.value===e.checkedValue),b=t(!1),x=t(!1),w=r(()=>{let{railStyle:t}=e;if(t)return t({focused:x.value,checked:_.value})});function E(t){let{"onUpdate:value":n,onChange:r,onUpdateValue:i}=e,{nTriggerFormInput:a,nTriggerFormChange:o}=l;n&&s(n,t),i&&s(i,t),r&&s(r,t),h.value=t,a(),o()}function D(){let{nTriggerFormFocus:e}=l;e()}function A(){let{nTriggerFormBlur:e}=l;e()}function M(){e.loading||m.value||(g.value===e.checkedValue?E(e.uncheckedValue):E(e.checkedValue))}function N(){x.value=!0,D()}function P(){x.value=!1,A(),b.value=!1}function F(t){e.loading||m.value||t.key===` `&&(g.value===e.checkedValue?E(e.uncheckedValue):E(e.checkedValue),b.value=!1)}function I(t){e.loading||m.value||t.key===` `&&(t.preventDefault(),b.value=!0)}let L=r(()=>{let{value:e}=d,{self:{opacityDisabled:t,railColor:n,railColorActive:r,buttonBoxShadow:i,buttonColor:a,boxShadowFocus:o,loadingColor:s,textColor:l,iconColor:u,[S(`buttonHeight`,e)]:m,[S(`buttonWidth`,e)]:h,[S(`buttonWidthPressed`,e)]:g,[S(`railHeight`,e)]:_,[S(`railWidth`,e)]:v,[S(`railBorderRadius`,e)]:y,[S(`buttonBorderRadius`,e)]:b},common:{cubicBezierEaseInOut:x}}=c.value,C,w,T;return j?(C=`calc((${_} - ${m}) / 2)`,w=`max(${_}, ${m})`,T=`max(${v}, calc(${v} + ${m} - ${_}))`):(C=p((f(_)-f(m))/2),w=p(Math.max(f(_),f(m))),T=f(_)>f(m)?v:p(f(v)+f(m)-f(_))),{"--n-bezier":x,"--n-button-border-radius":b,"--n-button-box-shadow":i,"--n-button-color":a,"--n-button-width":h,"--n-button-width-pressed":g,"--n-button-height":m,"--n-height":w,"--n-offset":C,"--n-opacity-disabled":t,"--n-rail-border-radius":y,"--n-rail-color":n,"--n-rail-color-active":r,"--n-rail-height":_,"--n-rail-width":v,"--n-width":T,"--n-box-shadow-focus":o,"--n-loading-color":s,"--n-text-color":l,"--n-icon-color":u}}),R=a?v(`switch`,r(()=>d.value[0]),L,e):void 0;return{handleClick:M,handleBlur:P,handleFocus:N,handleKeyup:F,handleKeydown:I,mergedRailStyle:w,pressed:b,mergedClsPrefix:i,mergedValue:g,checked:_,mergedDisabled:m,cssVars:a?void 0:L,themeClass:R?.themeClass,onRender:R?.onRender}},render(){let{mergedClsPrefix:e,mergedDisabled:t,checked:n,mergedRailStyle:r,onRender:o,$slots:s}=this;o?.();let{checked:u,unchecked:f,icon:p,"checked-icon":m,"unchecked-icon":h}=s,g=!(c(p)&&c(m)&&c(h));return i(`div`,{role:`switch`,"aria-checked":n,class:[`${e}-switch`,this.themeClass,g&&`${e}-switch--icon`,n&&`${e}-switch--active`,t&&`${e}-switch--disabled`,this.round&&`${e}-switch--round`,this.loading&&`${e}-switch--loading`,this.pressed&&`${e}-switch--pressed`,this.rubberBand&&`${e}-switch--rubber-band`],tabindex:this.mergedDisabled?void 0:0,style:this.cssVars,onClick:this.handleClick,onFocus:this.handleFocus,onBlur:this.handleBlur,onKeyup:this.handleKeyup,onKeydown:this.handleKeydown},i(`div`,{class:`${e}-switch__rail`,"aria-hidden":`true`,style:r},a(u,t=>a(f,n=>t||n?i(`div`,{"aria-hidden":!0,class:`${e}-switch__children-placeholder`},i(`div`,{class:`${e}-switch__rail-placeholder`},i(`div`,{class:`${e}-switch__button-placeholder`}),t),i(`div`,{class:`${e}-switch__rail-placeholder`},i(`div`,{class:`${e}-switch__button-placeholder`}),n)):null)),i(`div`,{class:`${e}-switch__button`},a(p,t=>a(m,n=>a(h,r=>i(l,null,{default:()=>this.loading?i(d,Object.assign({key:`loading`,clsPrefix:e,strokeWidth:20},this.spinProps)):this.checked&&(n||t)?i(`div`,{class:`${e}-switch__button-icon`,key:n?`checked-icon`:`icon`},n||t):!this.checked&&(r||t)?i(`div`,{class:`${e}-switch__button-icon`,key:r?`unchecked-icon`:`icon`},r||t):null})))),a(u,t=>t&&i(`div`,{key:`checked`,class:`${e}-switch__checked`},t)),a(f,t=>t&&i(`div`,{key:`unchecked`,class:`${e}-switch__unchecked`},t)))))}});export{M as t};
>>>>>>>> e53a2cc (feat: redesign console UI (dark+light design system) and add session management):web/dist/assets/Switch-hIX5t2y-.js
