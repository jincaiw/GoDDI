import{E as e,g as t,k as n}from"./echarts-Cw2yHLaZ.js";import{D as r}from"./vue-core-BDTvi3xZ.js";import{$ as i,G as a,J as o,K as s,N as c,P as l,Q as u,X as d,Y as f,Z as p,i as m}from"./light-BluJl8SD.js";import{t as h}from"./use-compitable-OuJoh8Ky.js";import{h as g}from"./DataTable-rwRmw5eb.js";import{h as _,st as v}from"./index-BUYVDbRn.js";function y(e,t=`default`,n=[]){let{children:r}=e;if(typeof r==`object`&&r&&!Array.isArray(r)){let e=r[t];if(typeof e==`function`)return e()}return n}var b=a([s(`descriptions`,{fontSize:`var(--n-font-size)`},[s(`descriptions-separator`,`
 ...
 `))]),x=`DESCRIPTION_ITEM_FLAG`;function S(e){return typeof e==`object`&&e&&!Array.isArray(e)?e.type&&e.type.DESCRIPTION_ITEM_FLAG:!1}var C=e({name:`Descriptions`,props:Object.assign(Object.assign({},m.props),{title:String,column:{type:Number,default:3},columns:Number,labelPlacement:{type:String,default:`top`},labelAlign:{type:String,default:`left`},separator:{type:String,default:`:`},size:String,bordered:Boolean,labelClass:String,labelStyle:[Object,String],contentClass:String,contentStyle:[Object,String]}),slots:Object,setup(e){let{mergedClsPrefixRef:n,inlineThemeDisabled:r,mergedComponentPropsRef:i}=l(e),a=t(()=>e.size||i?.value?.Descriptions?.size||`medium`),o=m(`Descriptions`,`-descriptions`,b,_,e,n),s=t(()=>{let{bordered:t}=e,n=a.value,{common:{cubicBezierEaseInOut:r},self:{titleTextColor:i,thColor:s,thColorModal:c,thColorPopover:l,thTextColor:u,thFontWeight:d,tdTextColor:f,tdColor:m,tdColorModal:h,tdColorPopover:g,borderColor:_,borderColorModal:v,borderColorPopover:y,borderRadius:b,lineHeight:x,[p(`fontSize`,n)]:S,[p(t?`thPaddingBordered`:`thPadding`,n)]:C,[p(t?`tdPaddingBordered`:`tdPadding`,n)]:w}}=o.value;return{"--n-title-text-color":i,"--n-th-padding":C,"--n-td-padding":w,"--n-font-size":S,"--n-bezier":r,"--n-th-font-weight":d,"--n-line-height":x,"--n-th-text-color":u,"--n-td-text-color":f,"--n-th-color":s,"--n-th-color-modal":c,"--n-th-color-popover":l,"--n-td-color":m,"--n-td-color-modal":h,"--n-td-color-popover":g,"--n-border-radius":b,"--n-border-color":_,"--n-border-color-modal":v,"--n-border-color-popover":y}}),u=r?c(`descriptions`,t(()=>{let t=``,{bordered:n}=e;return n&&(t+=`a`),t+=a.value[0],t}),s,e):void 0;return{mergedClsPrefix:n,cssVars:r?void 0:s,themeClass:u?.themeClass,onRender:u?.onRender,compitableColumn:h(e,[`columns`,`column`]),inlineThemeDisabled:r,mergedSize:a}},render(){let e=this.$slots.default,t=e?v(e()):[];t.length;let{contentClass:i,labelClass:a,compitableColumn:o,labelPlacement:s,labelAlign:c,mergedSize:l,bordered:u,title:d,cssVars:f,mergedClsPrefix:p,separator:m,onRender:h}=this;h?.();let _=t.filter(e=>S(e)),b=_.reduce((e,t,r)=>{let c=t.props||{},l=_.length-1===r,d=[`label`in c?c.label:y(t,`label`)],f=[y(t)],h=c.span||1,g=e.span;e.span+=h;let v=c.labelStyle||c[`label-style`]||this.labelStyle,b=c.contentStyle||c[`content-style`]||this.contentStyle;if(s===`left`)u?e.row.push(n(`th`,{class:[`${p}-descriptions-table-header`,a],colspan:1,style:v},d),n(`td`,{class:[`${p}-descriptions-table-content`,i],colspan:l?(o-g)*2+1:h*2-1,style:b},f)):e.row.push(n(`td`,{class:`${p}-descriptions-table-content`,colspan:l?(o-g)*2:h*2},n(`span`,{class:[`${p}-descriptions-table-content__label`,a],style:v},[...d,m&&n(`span`,{class:`${p}-descriptions-separator`},m)]),n(`span`,{class:[`${p}-descriptions-table-content__content`,i],style:b},f)));else{let t=l?(o-g)*2:h*2;e.row.push(n(`th`,{class:[`${p}-descriptions-table-header`,a],colspan:t,style:v},d)),e.secondRow.push(n(`td`,{class:[`${p}-descriptions-table-content`,i],colspan:t,style:b},f))}return(e.span>=o||l)&&(e.span=0,e.row.length&&(e.rows.push(e.row),e.row=[]),s!==`left`&&e.secondRow.length&&(e.rows.push(e.secondRow),e.secondRow=[])),e},{span:0,row:[],secondRow:[],rows:[]}).rows.map(e=>n(`tr`,{class:`${p}-descriptions-table-row`},e));return n(`div`,{style:f,class:[`${p}-descriptions`,this.themeClass,`${p}-descriptions--${s}-label-placement`,`${p}-descriptions--${c}-label-align`,`${p}-descriptions--${l}-size`,u&&`${p}-descriptions--bordered`]},d||this.$slots.header?n(`div`,{class:`${p}-descriptions-header`},d||g(this,`header`)):null,n(`div`,{class:`${p}-descriptions-table-wrapper`},n(`table`,{class:`${p}-descriptions-table`},n(`tbody`,null,s===`top`&&n(`tr`,{class:`${p}-descriptions-table-row`,style:{visibility:`collapse`}},r(o*2,n(`td`,null))),b))))}}),w={label:String,span:{type:Number,default:1},labelClass:String,labelStyle:[Object,String],contentClass:String,contentStyle:[Object,String]},T=e({name:`DescriptionsItem`,[x]:!0,props:w,slots:Object,render(){return null}});export{C as n,T as t};