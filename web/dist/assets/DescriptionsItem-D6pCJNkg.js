import{E as e,g as t,k as n}from"./vue.runtime.esm-bundler-B46jYzg4.js";import{Ar as r,Dn as i,Fr as a,Mr as o,Nr as s,On as c,Or as l,Pr as u,hr as d,ir as f,jr as p,kr as m,un as h,zn as g}from"./router-DwARj8rN.js";import{l as _}from"./DataTable-CE_s_imP.js";import{l as v}from"./index-BHa7GaUI.js";function y(e,t=`default`,n=[]){let{children:r}=e;if(typeof r==`object`&&r&&!Array.isArray(r)){let e=r[t];if(typeof e==`function`)return e()}return n}var b=l([m(`descriptions`,{fontSize:`var(--n-font-size)`},[m(`descriptions-separator`,`
